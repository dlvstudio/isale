...
export class OrderExportComponent {
    ...
    async generate() {
        ...
        this.excelService.getSalesReport(this.reportType, this.selectedStaff ? this.selectedStaff.id : 0, this.dateFrom, this.dateTo, this.store ? this.store.id : 0).then(async (report) => {
    ...
    async export(): Promise<void> {
        ...
        this.excelService.downloadExcelOrderReport(fileName, this.reportType, this.selectedStaff ? this.selectedStaff.id : 0, this.dateFrom, this.dateTo, this.store ? this.store.id : 0).then(async (url) => {
            await loading.dismiss();
