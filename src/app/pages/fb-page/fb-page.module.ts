...
@NgModule({
  ...
  declarations: [FbPageComponent, FbPageDetailComponent, FbMessageComponent, FbNotificationsComponent, FbCommentComponent, FbAutoReplyComponent, FbAutoReplyAddComponent, SearchPageComponent, FbLiveCommentComponent, FbAutoOrderComponent, FbAutoOrderAddComponent]
})
