...
export class CategoryDetailComponent {
    ...
    constructor(
        ...
        this.navCtrl.unsubscribe('reloadCategory', reloadCategoryHandle);
        this.navCtrl.subscribe('reloadCategory', reloadCategoryHandle);
    ...
    edit(): void {
        this.navCtrl.push('/category/add', { id: this.category.id });
    }
