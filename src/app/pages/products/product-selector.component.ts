...
export class ProductSelectorComponent {
    ...
    reloadProducts = async () => {
        ...
        const p = this.listOption === 'all'
            ? this.productService.getProducts(storeId, this.isMaterial)
            : this.listOption === 'expiry'
                ? this.productService.getProductsExpiry(storeId, this.isMaterial)
                : this.listOption === 'quantity'
                    ? this.productService.getProductsQuantity(storeId, this.isMaterial)
