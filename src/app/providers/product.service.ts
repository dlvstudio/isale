...
export class ProductService {
    ...
    getProducts(storeId, isMaterial = false): Promise<IProduct[]> {
    ...
    getProductsExpiry(storeId, isMaterial = false): Promise<IProduct[]> {
    ...
    getProductsQuantity(storeId, isMaterial = false): Promise<IProduct[]> {
