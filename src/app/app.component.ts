...
export class AppComponent {
    ...
    private async getShopConfig(): Promise<void> {
        ...
        await this.userService.setHideTablesFunction(hideTablesFunction);
        await this.userService.setHideCalendarFunction(hideCalendarFunction);
        await this.userService.setHideMaterials(hideMaterials);
    ...
    async initDatabase() {
        ...
        const currentLang = await this.userService.getCurrentLanguage();
        ...
        const dateFormat = await this.userService.getDateFormat();
        DateTimeService.resetDateFormat(dateFormat);

        const timeFormat = await this.userService.getTimeFormat();
        DateTimeService.resetTimeFormat(timeFormat);
    }
